 ...
 */
TransactionRoute.post('/', authMiddleware_1.authenticate, transactionController.createTransaction);
/**
 * @swagger
 * /transactions/{id}:
 *   delete:
 ...
 *         description: Token manquant ou invalide
 */
TransactionRoute.delete('/:id', authMiddleware_1.authenticate, transactionController.deleteTransaction);
